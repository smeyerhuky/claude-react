...
import MelSpectrogramVisualizer from './MelSpectrogramVisualizer';

// Enhanced version of ImageSonificationDJMixer with integrated mel spectrogram
const ImageSonificationDJMixerEnhanced = () => {
  // Original ImageSonificationDJMixer state
  ...
  // New state for spectrogram visualization
  ...
  // Make synthsRef available globally for analyzer access
  // (This is a workaround - in a production app, you'd use context or props)
  useEffect(() => {
    window.synthsRef = synthsRef;
    
    return () => {
      delete window.synthsRef;
    };
  }, []);
  ...
  const createTrack = (imageId, name, customSettings = {}) => {
    ...
    const trackConfig = {
      ...
      isExpanded: true, // New property for spectrogram view
      parameters: {
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={`px-2 py-1 text-sm rounded ${
                showSpectrogram ? "bg-blue-700" : "bg-gray-700"
              }`}
            >
              Spectrogram
            </button>
        ...
        {showSpectrogram && (
          <div className="relative">
            <MelSpectrogramVisualizer 
              ...
              updateTrackParameters={updateTrackParameters}
              changeTrackMethod={changeTrackMethod}
              changeTrackSynth={changeTrackSynth}
...
export default ImageSonificationDJMixerEnhanced;
